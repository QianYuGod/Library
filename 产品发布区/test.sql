...
-- Records 
-- ----------------------------
INSERT INTO `books` VALUES ('Android 4编程入门经典', 'Android 4编程入门经典', '李伟梦 ', '清华大学出版社', 'TCPAn169.23', 'Android4的问世，标志着Google将Android操作系统的大旗插到了智能手机和平板电脑的阵营中。这本指南书将教会您成功开发Android应用程序所需的一切', '1', null);
...
INSERT INTO `books` VALUES ('TCP/IP详解（卷2）：实现', '9787111075677', '（美）莱特，（美）史蒂文斯', '机械工业出版社', 'TCPcp231.1', '本书完整而详细地介绍了TCP/IP协议是如何实现的。书中给出了约500个图例，15 000行实际操作的C代码，采用举例教学的方法帮助你掌握TCP/IP实现。本书不仅说明了插口API和协议族的关系以及主机实现与路由器实现的差别。还介绍了4.4BSD-Lite版的新的特点，如多播、长肥管道支持、窗口缩放、时间戳选项以及其他主题等等。读者阅读本书时，应当具备卷1中阐述的关于TCP/IP的基本知识。', '1', null);
INSERT INTO `books` VALUES ('Web信息架构——设计大型网站（第3版）', '9787121215339', 'Peter Morville(彼得·莫维尔)，Louis Rosenfeld(路易斯·罗森菲尔德)', '电子工业出版社', 'TCPweb67.4', '　在由Wiki、Folksonomy及Mashup所构成的后Ajax化的Web 2．0世界中，精心设计的信息架构显得格外重要。你该如何向众人展现大量的信息，从而使他们能迅速找到所需的信息呢?这本经典之作将教导信息架构师、设计师及网站开发人员建立大型网站，使网站能够被管理，充满魅力，并且易于用户浏览。', '1', null);
...
INSERT INTO `books` VALUES ('操作系统', '23213213123', '谭浩强', '人民出版社', 'TCPOA13.2', '这本书包括了基本操作知识', '1', null);
...
INSERT INTO `books` VALUES ('计算机网络', '9787121201677', '谢希仁', '电子工业出版社', 'TCP3.45', '介绍网络的经典著作', '1', null);
...
INSERT INTO `users` VALUES ('123456', 'qwe', 'Student', 'cqb', '930826', 'SSE', 'null', '1208023', 'software Enginneer');
